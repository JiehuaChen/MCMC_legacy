...
index.na <- (1:dim(aflegacy)[1])*is.na(rowSums(aflegacy[, c("Clay", "Bot", "bio1", "bio12", "CTI_1K", "ELEV_1K", "EVIM_1K", "M13RB1ALT", "M13RB2ALT", "M13RB3ALT", "M13RB7ALT", "NPP_Mean_1", "RELIEF_1K", "SLOPE_1K", "lstday", "lstnight")]))
aflegacy <- aflegacy[-index.na, ]
aflegacy <- aflegacy[aflegacy$lstday<400, ]

logccm <- aflegacy$Clay
N <- length(logccm)
